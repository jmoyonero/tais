...
protected:
    ...
    struct TreeNode {
        ...
        TreeNode(T const &e, Link i = nullptr, Link d = nullptr,
                 int alt = 1, int tami = 1) : elem(e), iz(i), dr(d), altura(alt), tami(tami) {
        }
    };
...
public:
    ...
    T const &kesimo(int k, Link tree) const {
        ...
        return kesimo(k - tree->tami, tree->dr);
    }
...
void resuelveCaso() {
    ...
    ents.insert(25);
    ents.insert(30);
    cout << ents.kesimo(1) << endl;
    cout << ents.kesimo(3) << endl;
    ...
    ents1.insert(4);
    ents1.insert(32);
    cout << ents1.kesimo(2) << endl;
    cout << ents1.kesimo(4) << endl;
    cout << ents1.kesimo(5) << endl;
